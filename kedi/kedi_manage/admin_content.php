...
elseif($action=='del'){
	...
	msg('内容删除成功','admin_content.php?action=content_list&id='.$channel_id.'&lang='.$lang);
}
...
if($step=='1'){
	...
	cache_write(DATA_PATH.'cache_arr/content_arr.php',$str);
	show_htm("【{$id_arr[0]['title']}】文章成功删除",'?action=del_all&channel_id='.$channel_id.'&step=1&lang='.$lang);
	}else{
